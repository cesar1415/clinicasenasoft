...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'enfermera.appointments']);
        Permission::create(['name' => 'enfermera.assign_specialty']);
        Permission::create(['name' => 'enfermera.schedule.assignment']);
        Permission::create(['name' => 'enfermera.schedule.assign']);
        Permission::create(['name' => 'enfermera.update_specialty']);
        ...
        $admin->givePermissionTo([
            ...
            'change_password',
            'enfermera.appointments',
            'enfermera.assign_specialty',
            'enfermera.schedule.assignment',
            'enfermera.schedule.assign',
            'enfermera.update_specialty',
