...
// class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function visible_users(){
        if($this->hasRole('Admin')) {
            $users = self::all();
        }else if($this->hasRole('Enfermera')){
    ...
    public function visible_roles(){
        ...
        if($this->hasRole('Secretary') || $this->hasRole('Enfermera')){
    ...
    // relaciones para deshabilitar los horarios para la enfermera
    public function enfermera_schedules(){
        return $this->hasMany('App\EnfermeraSchedule');
    }
    ...
    */
    ...
    public function enfermera_appointments(){
        return $this->hasMany('App\Appointment', 'enfermera_id');
    }

    // relacion de recetas medicas
    public function enfermera_recipes(){
        return $this->hasMany('App\Recipe', 'enfermera_id');
    }
