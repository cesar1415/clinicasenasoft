@if (!isset($appointment))
  @if (Auth::user()->hasRole('Enfermera'))
    <input type="hidden" name="enfermera" value="{{ Auth::id() }}">
  @else
    <div class="form-row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
          <div class="form-group">
          <label for="enfermera">Seleccione un enfermera</label>
          <div class="input-group">
              <div class="input-group-prepend">
              <span class="input-group-text"><i class="fas fa-user-md"></i></span>
              </div>
              <select class="form-control" name="enfermera" id="enfermera">
              <option selected disabled>Seleccione un docenfermerator</option>
              {{--  enfermeras  --}}
              </select>
          </div>
          </div>
