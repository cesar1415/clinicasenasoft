...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Especialidades medicas</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Especialidades medicas</h3>
                  <div class="card-tools">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" role="menu">
                        <a href="{{route('specialties.create')}}" class="dropdown-item">Registrar</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="{{route('specialties.show', $specialty)}}">
                                    <i class="fas fa-folder">
                                    </i>
                                    Ver
                                </a>
                                <a class="btn btn-info btn-sm" href="{{route('specialties.edit', $specialty)}}">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                    Editar
                                </a>
                                <a class="btn btn-danger btn-sm" href="#" onclick="enviar_formulario()">
