<div class="list-group mb-4">
    @if (Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Secretary') || Auth::user()->hasRole('Enfermera'))
    ...
    ">
        ...
        <a href="{{route('enfermera.schedule.assign', $user)}}" class="list-group-item list-group-item-action
        {!! active_class(route('enfermera.schedule.assign', $user)) !!}
        ">
            Gestión de horarios
        </a>
        @endif
    ...
    @if (Auth::user()->hasRole('Admin'))
        {{--  asignar roles  --}}
        @if ($user->hasRole('Enfermera'))
            <a href="{{route('enfermera.assign_specialty', $user)}}" class="list-group-item list-group-item-action
            {!! active_class(route('enfermera.assign_specialty', $user)) !!}
            ">
