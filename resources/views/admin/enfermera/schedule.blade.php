        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card">
                ...
                {!! Form::open(['route'=>['enfermera.schedule.assignment', $user], 'method'=>'POST']) !!}
                <div class="card-body">
